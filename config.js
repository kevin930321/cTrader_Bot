...
const ctraderMode = getEnvString("CTRADER_MODE", "demo");
const marketSymbol = getEnvString("CTRADER_SYMBOL", "US30");
const mongodbUri = getEnvString(
  "MONGODB_URI",
  "mongodb://localhost:27017/trading-bot",
);
...
module.exports = {
  ...
  ctrader: {
    ...
    host:
      ctraderMode === "demo" ? "demo.ctraderapi.com" : "live.ctraderapi.com",
  ...
  // 市場時間設定 (CME Globex)
  market: {
    symbol: marketSymbol, // cTrader symbol name
